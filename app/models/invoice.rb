class Invoice < ApplicationRecord
  ...
  def reassign_order_code!
    update!(payos_order_code: 72_000_000_000 + (Time.now.to_i % 1_000_000_000) + rand(0..999),
            checkout_url: nil)
  end
  ...
  def assign_order_code
    self.payos_order_code ||= 72_000_000_000 + SecureRandom.random_number(1_000_000_000)
  end
end
